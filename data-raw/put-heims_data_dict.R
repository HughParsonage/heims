...
list(
  ...
  "E312" = list(long_name = "Special_course",
                ...
                valid = function(v) v %fin% c(0, 21:23, 25:27)),
  ...
  "E392" = list(long_name = "Max_student_contr_ind",
                ...
                valid = function(v) v %fin% c(0, 7, 5)),
  ...
  "E460" = list(long_name = "Prev_RTS_EFTSL",
                ...
                valid = function(v) if (is.integer(v)) between(v, 0, 9999) else v %fin% seq.int(0, 9999)),
